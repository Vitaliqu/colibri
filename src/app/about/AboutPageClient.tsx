    ...
    const teamMembers = [
        {
            ...
            bio: "Закінчив стомат факультет Донецького медичного університету...",
        },
        {
            name: "Ольга Щербан",
            role: "Ортодонт",
            ...
            bio: "Закінчила стомат факультет Донецького медичного університету...",
        },
        {
            ...
            bio: "Закінчила стомат факультет Ужгородського університету...",
        },
    ];
