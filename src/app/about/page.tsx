            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        image: "https://kolibri-khust.com/og-image.jpg",
                        ...
                        address: {
                            ...
                            addressCountry: "UA",
                            streetAddress: "вулиця Пирогова 5а, Хуст, Закарпатська область, Україна, 90400",
                        },
                        description:
                            "Стоматологія Колібрі у Хусті — сучасна клініка з професійним лікуванням зубів, імплантацією, гігієною та дитячою стоматологією.",
                    }),
                }}
            />
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div
                            ...
                            <p className="text-sm md:text-xl h-auto mt-2 leading-relaxed mb-8">
                                ...
                                та життя завдяки турботливому та сучасному лікуванню. Нашамісія проста: надавати
                                виняткові
