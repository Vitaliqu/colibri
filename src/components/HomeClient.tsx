            ...
            <div className="flex justify-center text-center px-4 sm:px-6 lg:px-8 relative">
                <div className="w-full max-w-3xl mx-auto flex flex-col items-center">
                    ...
                    <p className="text-gray-700 mb-6 max-w-xl leading-relaxed animate-fade-in-delay">
                        Стоматологія Колібрі у Хусті – це місце, де якість та турбота про пацієнта стоїть на першому
                        місці. Наші фахівці поєднують сучасні технології з індивідуальним підходом до кожного клієнта.
